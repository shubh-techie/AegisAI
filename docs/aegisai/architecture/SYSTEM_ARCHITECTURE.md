...
and four decision outcomes in Model C. [SPEC-008](../specs/SPEC-008-AUDIT-OBSERVABILITY.md)
adds best-effort structured decision audit and tracing/metrics. Durable audit, protected
resource enforcement, and provider deployment integration remain PLANNED. The following design is the target specified by [SPEC-003](../specs/SPEC-003-AEGISAI-ARCHITECTURE.md).
